...
**读法**：W34 是建库初始爆发（不可比）；**W35→W38 提交量稳定在 ~35/周，但新知识产出率 41%→11% 单调下降，重复率 59%→89%** —— 即“投入照旧、新知识越来越少”。
...
**结论：W38 的高重复率由「真重复」驱动（19/31=61%），误杀在 W38 为 0。**
且有 **11 个卡名被反复提交**，其中 `llm-dedup-gateway-degrade-fix.md` 与
`flywheel-weixin-rate-limit-diagnosis.md` **各 4 次**——这是真·漂移的典型特征。
⇒ **属“知识被反复提交”（漂移/返工），而非“去重门禁误杀”。**
（误杀总体仅 5/116=4%，虽非零但不主导。）

### 诚实结论
**门禁状态已确认干净**（后窗口 2/2 天全 0），但**趋势未成立**——n=2 天排除不了偶然。
根因已定性（真漂移，非误杀），但仍需时间验证改造是否改善它。
