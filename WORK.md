...
| **AUD** | **全面分析产出物** | 报告 `docs/compose/reports/2026-09-25-project-audit.md`（**7.7/10**）。待办：P1 六项（ruff 规则集 / 覆盖率基线 / 硬编码清零 / `work/` 迁入 / 推送 / 单点降级）、P2 五项、重构候选 A–D；**顺序建议 P1-c→a→b→d→e→f** |
